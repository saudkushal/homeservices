        ...
        <div class="login h-[82vh] w-[70vh] bg-blue-100 border rounded-3xl">
            ...
            <div class="admin flex flex-col items-center pt-10">
                <img src="{{ asset('homeimages/cleaning1.jpg') }}"
                    class="h-[30vh] w-[30vw] border border-blue-600 border-x-4">
            </div>
            ...
            <form action="{{ route('ulogin') }}" method="POST" class="form gap-5 pt-5 flex flex-col items-center">
                @csrf
                <input type="text" name="e-mail" id="input" placeholder="Username"
                ...
                <a href="{{ route('usersignup') }}"
                    class="btn btn-primary pr-10 font-bold text-blue-800 w-full text-right text-black">
                    Sign-Up?</a>

                <button type="submit" class="bg-blue-800 text-white border rounded-full h-9 w-[100px]">Login</button>
            </form>
